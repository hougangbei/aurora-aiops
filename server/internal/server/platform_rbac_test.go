...
func TestRequiredPlatformRoles(t *testing.T) {
	tests := []struct {
		...
		{http.MethodGet, "/api/v1/assets/servers/:id", nil},
		{http.MethodGet, "/api/v1/assets/servers/:id/snapshots/latest", nil},
		{http.MethodGet, "/api/v1/assets/servers/:id/software", nil},
		{http.MethodGet, "/api/v1/projects", nil},
		{http.MethodGet, "/api/v1/projects/:projectID", nil},
		{http.MethodPost, "/api/v1/projects/:projectID/install", []auth.Role{auth.RoleAdmin}},
		{http.MethodGet, "/api/v1/assets/servers/:serverID/tasks", nil},
		{http.MethodGet, "/api/v1/assets/servers/:serverID/installations", nil},
		{http.MethodGet, "/api/v1/deployment-tasks/:taskID", nil},
		{http.MethodGet, "/api/v1/deployment-tasks/:taskID/events", nil},
		{http.MethodPost, "/api/v1/deployment-tasks/:taskID/cancel", []auth.Role{auth.RoleAdmin}},
		{http.MethodPost, "/api/v1/deployment-tasks/:taskID/retry", []auth.Role{auth.RoleAdmin}},
